          ...
          children: [
            ...
            Flexible(
              child: Text(
                ...
                style: TextStyle(
                    fontWeight: FontWeight.bold, fontSize: 24.sp, color: Colors.blueAccent[700]),
              ),
            ),
            Flexible(
              child: Text(
          ...
          children: [
            ...
            Flexible(
              child: Column(
                children: [
                  Flexible(
                    child: mycustom_ShowDialogbutton_Blue(context,
                        bttttname: 'Try Again',
                        myCCustomDialog: success_AlertDialog(context, message: 'Congratulations'),
                        btFontSize: 20,
