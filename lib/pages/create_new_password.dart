            ...
            children: [
              ...
              Column(
                children: [
                  ...
                  myPasswordField(icon: const Icon(Icons.lock), hintText: "Enter New Password", suffixIcon: const Icon(Icons.visibility_off)),
                  SizedBox(height: 10.h),
                  myPasswordField(icon: const Icon(Icons.lock), hintText: "Repeat Your Password", suffixIcon: const Icon(Icons.visibility_off)),
                  CheckboxListTile(
